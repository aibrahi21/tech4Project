...
public class StudentTest  {
    public static void main(String[] args) {
        ...
        * id = 1001*/
        ...
        System.out.println(count+" live in chicago");
        System.out.println();

        /*
        Count how many students are male
        Count how many students are female
        EXPECTED
        male = 3
        female = 2
         */
        ...
        System.out.println("male = "+count2);
        System.out.println("female = "+count3);
        System.out.println();
        ...
        System.out.println("teens = "+count4);
        System.out.println();
        /*
